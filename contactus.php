<html>
    <head>
        <title>CONTACT-US | EDUCARE </title>
    </head>
    <style>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO `contact` (`c_name`,`c_mail`,`c_msg`) VALUES ('$name','$email', '$msg')";
    ...
    <form action="contactus.php" method="post" class="wpcf7-form">
        ...
        <p>
           <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="name" value="" size="40" class="nameinput wpcf7-fod"  placeholder="Name" required>  
          </span>
          <span class="wpcf7-form-control-wrap Email">
            <input type="email" name="email"  class="emailinput" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  placeholder="Email" required>
          </span>
